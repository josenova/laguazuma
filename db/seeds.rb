...
rooms = Room.create([
	...
	{ number: 7, size: 50, capacity: 2, beds: 1, bathrooms: 1, airbnb_id: '40026090', description: "Our latest addition: plenty of space, king bed, romantic morrocan decor and a private hot tub with infinity views." }
])