...
rooms = Room.create([
	{ number: 1, size: 48, capacity: 4, beds: 3, bathrooms: 1, airbnb_id: '12671306', description: "A double bed, a bunk bed and plenty of space makes this room ideal for families of 4. The en-suite bathroom's toilet is strategically positioned to enjoy the view while on duty." }, 
	...
	{ number: 4, size: 20, capacity: 3, beds: 2, bathrooms: 1, airbnb_id: '15048434', description: "This room is only available for rent alongside room #3 as its right under it, which makes them ideal for two couples or groups of five." },
