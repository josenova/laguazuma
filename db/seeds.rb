...
rooms = Room.create([
	{ number: 1, size: 48, capacity: 4, beds: 2, bathrooms: 1, airbnb_id: '12671306', description: "A double bed and a sofa bed makes this room ideal for families of 4. The en-suite bathroom's toilet is strategically positioned to enjoy the view while on duty." }, 
